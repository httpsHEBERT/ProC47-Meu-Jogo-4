...
{ //pre carregamento e configurações
  ...
  function setup(){
    ...
    tituloA = createSprite(width/2-150, height-130);
    ...
    controle = createSprite(width/2, height/2);
...
{ //jogo
  ...
  function nave(){
    ...
    if(keyDown("space") && espaco === "nao"){
      ...
      var cores = Math.round(random(1, 5));
  ...
  function mudancaDeCor(){
    ...
    if(lixosQ >= 17){
      asteroideM.addImage(asteroide1);
    }else{
      asteroideM.addImage(asteroide0);
    }
